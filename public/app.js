  ...
  return `
    <div class="page home-page studio-home">
      <section class="studio-hero">
        ...
        <div class="studio-hero-inner shell">
          ...
          <div class="studio-scene">
            <a class="studio-desktop" href="sites/zhang-hong/" aria-label="打开张红作品集实际网站">
              <div class="device-toolbar"><span>张红 / 灯光与合成作品集</span><span aria-hidden="true">↗</span></div>
              <img src="assets/zhang-hong-site-preview.png" alt="已交付的张红作品集桌面端首页" width="1440" height="1000" fetchpriority="high">
            </a>
            <a class="studio-phone" href="sites/zhang-hong/" aria-label="打开张红作品集"><img src="assets/zhang-hong-mobile-preview.png" alt="同一作品集的真实移动端页面" width="390" height="844"></a>
          </div>
        </div>
        <div class="scene-caption shell"><span>实际交付页面展示</span><p>张红 · 灯光与合成作品集</p><a href="sites/zhang-hong/">打开完整网站 ↗</a></div>
      </section>
      ...
      <section class="section shell showcase-section" id="work">
        ...
        <div class="showcase-case-head"><div><span class="case-kicker">已交付作品集</span><h3>张红 <span>灯光与合成</span></h3></div><a class="inline-action" href="sites/zhang-hong/">打开完整网站 ↗</a></div>
        <div class="craft-showcase" data-view="desktop">
          ...
          <div class="craft-body" id="craft-panel" role="tabpanel" aria-labelledby="view-tab-desktop">
            <div class="craft-screen"><img id="craft-image" src="assets/zhang-hong-site-preview.png" width="1440" height="1000" alt="张红作品集首屏实际截图" loading="lazy"></div>
      ...
      <section class="section shell craft-section" id="details">
        ...
        <div class="craft-grid">
          <article class="craft-feature-media"><div class="media-slices"><a href="sites/zhang-hong/" aria-label="进入张红作品集查看绯雪项目"><img src="sites/zhang-hong/assets/wuwa-hiyuki.webp" alt="客户作品集中绯雪项目的官方封面" loading="lazy"><span class="project-image-caption">绯雪 <span aria-hidden="true">↗</span></span></a><a href="sites/zhang-hong/" aria-label="进入张红作品集查看珂莱塔项目"><img src="sites/zhang-hong/assets/wuwa-carlotta.webp" alt="同一客户作品集中珂莱塔项目的官方封面" loading="lazy"><span class="project-image-caption">珂莱塔 <span aria-hidden="true">↗</span></span></a></div><div class="craft-tile-copy"><span>01 — 作品呈现</span><h3>让画面充分展开。</h3><p>大图、影像和项目细节按阅读顺序展开。<br>先看到作品，再了解过程。</p></div></article>
          <article class="craft-feature-type"><span>02 — 内容表达</span><h3>把个人贡献，<br>写在作品旁边。</h3><p>不让漂亮封面替代真实能力。</p><div class="content-evidence"><div><small>专业定位</small><strong>灯光与合成</strong></div><div><small>代表项目</small><strong>角色宣传 CG / 动画电影</strong></div><div><small>个人职责</small><strong>UE 灯光、Nuke 合成</strong></div></div><p class="tile-footnote">内容摘自张红作品集。</p></article>
        </div>
      </section>
      ...
      <section class="section shell studio-process" id="process">
        ...
        <figure class="process-preview"><div class="process-preview-label"><span>交付视角</span><span id="process-preview-count">01 / 03</span></div><div class="process-preview-image"><img id="process-preview-image" src="assets/zhang-hong-work-preview.png" alt="张红作品集中的项目编排实例" loading="lazy"></div><figcaption><span id="process-preview-title">找到经历中的重点</span><small>已交付案例 · 张红作品集</small></figcaption></figure>
...
function bindShowcase() {
  ...
  let disposed = false;
  const views = {
    desktop: {src:'assets/zhang-hong-site-preview.png',alt:'张红作品集首屏实际截图',title:'先让作品，<br>建立第一印象。',copy:'用代表作建立页面气质，再交代专业方向与个人职责。画面有分量，信息也有先后。',details:['沉浸式作品首屏','清晰的专业定位','可直接进入项目详情']},
    works: {src:'assets/zhang-hong-work-preview.png',alt:'张红作品集作品编排实际截图',title:'不只放图片，<br>也交代你做过什么。',copy:'按项目组织图像、视频与制作说明，把团队作品与个人参与的边界讲清楚。',details:['代表项目优先呈现','图集与视频按需展开','职责说明与内容对应']},
    mobile: {src:'assets/zhang-hong-mobile-preview.png',alt:'张红作品集手机端实际截图',title:'换一块屏幕，<br>体验仍然完整。',copy:'重新安排窄屏上的阅读顺序、触控区域和画面比例，不是把电脑页面简单缩小。',details:['适配手机的内容布局','触控友好的浏览入口','重要信息优先可见']}
  };
...
function bindProcess() {
  const views = [
    ['assets/zhang-hong-work-preview.png', '找到经历中的重点', '张红作品集中的项目编排实例'],
    ['assets/zhang-hong-site-preview.png', '让内容有自己的视觉表达', '张红作品集桌面端实际交付页面'],
    ['assets/zhang-hong-mobile-preview.png', '每一种屏幕，都认真适配', '张红作品集手机端实际交付页面']
  ];
